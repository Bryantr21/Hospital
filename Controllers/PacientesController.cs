...
namespace Hospital.Controllers
{
    public class PacientesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_paciente,nombre,fecha_nacimiento,telefono,direccion")] Paciente paciente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_paciente,nombre,fecha_nacimiento,telefono,direccion")] Paciente paciente)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            db.SaveChanges();
            SweetAlert("Eliminado", "paciente eliminado", NotificationType.success);
