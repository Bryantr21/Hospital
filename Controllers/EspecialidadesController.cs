...
namespace Hospital.Controllers
{
    public class EspecialidadesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_especialidad,nombre")] Especialidade especialidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_especialidad,nombre")] Especialidade especialidade)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            db.SaveChanges();
            SweetAlert("Eliminada", "especialidad eliminada", NotificationType.success);
